...
public class EntityServiceImpl implements EntityService {
     ...
     *
     * @param parentEntity EntityDao - parent entity
     * @return Boolean
     */
     ...
     *
     * @param result EntityDao - parent entity
     */
    ...
    public ResponseDto bulkUpdateCompetencies(MultipartFile multipartFile, String userId) {
        ResponseDto response = createDefaultResponse("api.bulk.v2.competency");
        File file = null;
        FileInputStream fis = null;
        XSSFWorkbook wb = null;
        try {
            Map<String, List<Object>> competencyMap = new HashMap<>();
                ...
                while (rowIterator.hasNext()) {
                    ...
                    if (nextRow.getCell(0).getCellType() != CellType.STRING) {
                        ...
                        if (entityDaoName == null) {
                            ...
                            entityDaoName.setStatus("VERIFIED");
                            entityDaoName.setAdditionalProperties(additionalProperties);
                            entityDaoName.setCreatedBy(userId);
                            entityDaoName = addUpdateEntity(entityDaoName, userId);
                        ...
                        if (entityDaoSubtheme == null) {
                            ...
                            entityDaoSubtheme.setStatus("VERIFIED");
                            entityDaoSubtheme.setDescription(competencySubTheme + " Competency Sub-Theme");
                            entityDaoSubtheme.setCreatedBy(userId);
                            entityDaoSubtheme = addUpdateEntity(entityDaoSubtheme, userId);
                        }
                        if (entityDaoSubtheme != null) {
            ...
            response.getResult().put("ERROR_MESSAGE", e.getMessage());
